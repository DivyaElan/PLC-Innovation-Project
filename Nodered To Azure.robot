...
${HOST NAME}		plcedgesolutionhub.azure-devices.net
...
Deploy Test Flow
	...
	#	Click Element	xpath://div[@class='ui-droppable']//*[local-name()='svg']//*[name()='g']//*[name()='g' and contains(@class,'red-ui-wor')]//*[name()='g']//*[name()='g'][1]/*[name()='g' and contains(@class,'red-ui-flow-node-button')][1]//*[name()='rect'][2]
	Click Element	xpath://div[@id='red-ui-workspace-chart']//*[local-name()='svg']//*[name()='g']//*[name()='g' and contains(@class,'red-ui-wor')]//*[name()='g']//*[name()='g' and @id='896e40c5.49d3d']//*[name()='g' and contains(@class,'red-ui-flo')]//*[name()='rect'][2]
	...
	Sleep	5s
	Assign Id to Element	xpath://input[@id='node-input-hostname']	Host_Name
	Input Text	Host_Name	${HOST NAME}
	Click Element	id:node-dialog-ok
